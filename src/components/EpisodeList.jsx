...
export default function EpisodeList({ malId }) {
  ...
  if (!anime) return <div className="text-center p-20 text-white">Loading anime...</div>;
  ...
  return (
    <div className="container mx-auto p-4 text-white">
      ...
      {/* ✅ REAL VIDEO PLAYER — PLAYS ACTUAL ANIME EPISODES */}
      {currentStream && (
        <div className="mb-8">
